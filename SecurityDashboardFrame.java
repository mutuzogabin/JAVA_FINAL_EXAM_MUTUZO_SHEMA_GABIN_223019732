...
public class SecurityDashboardFrame extends JFrame {
    private final User loggedUser;
    private final JPanel mainPanel;
    private final CardLayout cardLayout;

    public SecurityDashboardFrame(User user) {
        this.loggedUser = user;
        setTitle("Security Dashboard - SECURITY MONITORING MANAGEMENT SYSTEM");
        setSize(1000, 700);
        ...
        JButton updateEventStatusBtn = createSidebarButton("Update Event Status");
        ...
        sidebar.add(updateEventStatusBtn);
        sidebar.add(Box.createVerticalStrut(10));
        ...
        updateEventStatusBtn.addActionListener(e -> cardLayout.show(mainPanel, "UPDATE_EVENT"));
